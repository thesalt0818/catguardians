    ...
    execute: function () {
      ...
      var BuildingManager = exports('BuildingManager', (_dec = ccclass('BuildingManager'), _dec2 = property(SpriteFrame), _dec3 = property(SpriteFrame), _dec4 = property(ProgressBar), _dec5 = property(Node), _dec6 = property(Node), _dec7 = property([SpriteFrame]), _dec8 = property(Label), _dec9 = property(PopupControl), _dec(_class = (_class2 = /*#__PURE__*/function (_Component) {
        ...
        function BuildingManager() {
          ...
          _initializerDefineProperty(_this, "MAX_LEVEL", _descriptor11, _assertThisInitialized(_this));
          _this.sprite = null;
          _this.isBuilding = false;
        ...
        _proto.update = function update(dt) {
          if (this.isBuilding) {
            ...
            if (this.currentLevel >= this.MAX_LEVEL) return;
            ...
            if (this.levelTimer >= this.levelUpInterval) {
              ...
              this.currentLevel++;
              this.updateLevelUI();
              if (this.currentLevel % 10 === 0 && this.currentLevel < this.MAX_LEVEL) {
        ...
        _proto.hideSubButtons = function hideSubButtons() {
          this.subButtons.forEach(function (btn) {
            tween(btn).to(0.1, {
              scale: new Vec3(0, 0, 0)
            }).call(function () {
      ...
      }), _descriptor11 = _applyDecoratedDescriptor(_class2.prototype, "MAX_LEVEL", [property], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function initializer() {
...
System.register("chunks:///_virtual/CameraMovement.ts", ['./rollupPluginModLoBabelHelpers.js', 'cc'], function (exports) {
  var _applyDecoratedDescriptor, _inheritsLoose, _initializerDefineProperty, _assertThisInitialized, cclegacy, _decorator, Camera, Vec3, input, Input, EventMouse, math, Vec2, Component;
  return {
    setters: [function (module) {
      _applyDecoratedDescriptor = module.applyDecoratedDescriptor;
      _inheritsLoose = module.inheritsLoose;
    ...
    execute: function () {
      ...
      var CameraMovement = exports('CameraMovement', (_dec = ccclass('CameraMovement'), _dec2 = property(Camera), _dec(_class = (_class2 = /*#__PURE__*/function (_Component) {
        ...
        function CameraMovement() {
          ...
          _initializerDefineProperty(_this, "zoomSpeed", _descriptor2, _assertThisInitialized(_this));
          // 줌 속도
          _initializerDefineProperty(_this, "minZoom", _descriptor3, _assertThisInitialized(_this));
          // 최소 줌 (확대 제한)
          _initializerDefineProperty(_this, "maxZoom", _descriptor4, _assertThisInitialized(_this));
          // 최대 줌 (축소 제한)
          _this._isDragging = false;
          _this._lastPosition = new Vec3();
          _this._tempVec3 = new Vec3();
          // 핀치 줌을 위한 변수
          _this._lastTouchDist = 0;
          return _this;
        }
        ...
        _proto.startDragging = function startDragging(x, y) {
          this._isDragging = true;
          this._lastPosition.set(x, y, 0);
        };
        _proto.updatePosition = function updatePosition(x, y) {
          var currentPosition = new Vec3(x, y, 0);
          Vec3.subtract(this._tempVec3, currentPosition, this._lastPosition);
        ...
        _proto.onMouseDown = function onMouseDown(event) {
          if (event.getButton() === EventMouse.BUTTON_LEFT) this.startDragging(event.getLocationX(), event.getLocationY());
        };
        _proto.onMouseMove = function onMouseMove(event) {
          if (this._isDragging) this.updatePosition(event.getLocationX(), event.getLocationY());
        };
        _proto.onMouseUp = function onMouseUp(event) {
          if (event.getButton() === EventMouse.BUTTON_LEFT) this._isDragging = false;
        }
        ...
        _proto.onTouchStart = function onTouchStart(event) {
          ...
          if (touches.length === 1) {
            this.startDragging(event.getLocationX(), event.getLocationY());
          } else if (touches.length >= 2) {
            // 두 손가락이 닿으면 드래그 중지하고 줌 준비
            this._isDragging = false;
            this._lastTouchDist = this.getTouchDistance(touches[0], touches[1]);
          }
        };
        _proto.onTouchMove = function onTouchMove(event) {
          var touches = event.getAllTouches();
          if (touches.length === 1 && this._isDragging) {
            this.updatePosition(event.getLocationX(), event.getLocationY());
          } else if (touches.length >= 2) {
            // 핀치 줌 로직
            var currentDist = this.getTouchDistance(touches[0], touches[1]);
            var diff = currentDist - this._lastTouchDist;
            if (this.cameraComponent) {
              // Ortho Height를 조절하여 줌 구현
              var newHeight = this.cameraComponent.orthoHeight - diff * this.zoomSpeed;
              // 줌 범위 제한
              this.cameraComponent.orthoHeight = math.clamp(newHeight, this.minZoom, this.maxZoom);
            }
            this._lastTouchDist = currentDist;
          }
        };
        ...
        // 두 손가락 사이의 거리를 계산하는 유틸리티 함수
        ;

        _proto.getTouchDistance = function getTouchDistance(touchA, touchB) {
          var posA = touchA.getLocation();
          var posB = touchB.getLocation();
          return Vec2.distance(posA, posB);
        };
      ...
      }), _descriptor2 = _applyDecoratedDescriptor(_class2.prototype, "zoomSpeed", [property], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function initializer() {
      ...
      }), _descriptor3 = _applyDecoratedDescriptor(_class2.prototype, "minZoom", [property], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function initializer() {
      ...
      }), _descriptor4 = _applyDecoratedDescriptor(_class2.prototype, "maxZoom", [property], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function initializer() {
    ...
    execute: function () {
      ...
      var IconControl = exports('IconControl', (_dec = ccclass('IconControl'), _dec2 = property(BuildingManager), _dec3 = property(Node), _dec(_class = (_class2 = /*#__PURE__*/function (_Component) {
        ...
        _proto.onIconClick = function onIconClick() {
          ...
          if (this.buildingMgr) {
            // 함수가 존재하는지 안전하게 체크 후 호출
            if (typeof this.buildingMgr.hideSubButtons === 'function') {
              this.buildingMgr.hideSubButtons();
            } else {
              console.error("BuildingManager에 hideSubButtons 함수가 없습니다!");
            }
          }
        };
        return IconControl;
...
System.register("chunks:///_virtual/main", ['./BtnClick.ts', './BuildingChange.ts', './BuildingManager.ts', './CamerControl.ts', './CameraMovement.ts', './CameraZoom.ts', './DragMovement.ts', './IconControl.ts', './ImageHoverScale.ts', './ImageSwitcher.ts', './PopupControl.ts', './SceneSwitcher.ts', './ScreenControl.ts', './TitleScene.ts'], function () {
  return {
...
System.register("chunks:///_virtual/ScreenControl.ts", ['./rollupPluginModLoBabelHelpers.js', 'cc'], function (exports) {
  ...
  return {
    ...
    execute: function () {
      var _dec, _class;
      cclegacy._RF.push({}, "79fa7ET8mBNdLpRQQDCaotW", "ScreenControl", undefined);
      var ccclass = _decorator.ccclass,
        property = _decorator.property;
      var ScreenControl = exports('ScreenControl', (_dec = ccclass('ScreenControl'), _dec(_class = /*#__PURE__*/function (_Component) {
        _inheritsLoose(ScreenControl, _Component);
        ...
        var _proto = ScreenControl.prototype;
        /**
         * 버튼에 연결할 함수
         */
        _proto.toggleFullScreen = function toggleFullScreen() {
          ...
          if (!this._isFullScreen) {
            ...
            screen.exitFullScreen().then(function () {
              ...
              console.log("일반 웹 모드 활성화");
            });
          }

          // 화면 크기 재설정 (레이아웃 틀어짐 방지)
